...
Example of a Resource JSON, loosely combines the W3C WebID Community Group [Draft](https://w3c.github.io/WebID/working_documents/webid-core-jacopo.html), [Solid lite WebID definitions](https://solid-lite.github.io/WebID/ ), [Schema.org](https://developers.google.com/search/updates#february-2024) and [ActivityPub](https://www.w3.org/TR/activitypub/):
